...
class makeOrderRequest final :
 ...
 public:
  ...
  void set_allocated_goods(std::string* ptr);
...
class makeOrderResponse final :
 ...
 public:
  ...
  void set_allocated_res_info(std::string* ptr);
...
inline PROTOBUF_ALWAYS_INLINE void makeOrderRequest::set_goods(Arg_&& arg,
                                                     Args_... args) {
  ;
  _impl_.goods_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void makeOrderRequest::set_allocated_goods(std::string* value) {
  _impl_.goods_.SetAllocated(value, GetArenaForAllocation());
...
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void makeOrderResponse::set_res_info(Arg_&& arg,
                                                     Args_... args) {
  ;
  _impl_.res_info_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void makeOrderResponse::set_allocated_res_info(std::string* value) {
  _impl_.res_info_.SetAllocated(value, GetArenaForAllocation());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void makeOrderResponse::set_order_id(Arg_&& arg,
                                                     Args_... args) {
  ;
...
inline void makeOrderResponse::set_allocated_order_id(std::string* value) {
